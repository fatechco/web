...
export const DEFAULT_LANGUAGE_CODE = process.env.NEXT_PUBLIC_DEFAULT_LANGUAGE_CODE;
export const DEFAULT_PRIMARY_COLOR = "#BB9B6A";
export const DEFAULT_PRIMARY_BUTTON_FONT_COLOR = "#ffffff";
